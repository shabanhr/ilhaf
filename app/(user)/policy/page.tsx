...
import { siteLink, domain, siteEmail } from '@/config';
...
export const metadata = getMetadata({
	...
	description: `At ${domain}, we take your privacy seriously.`,
	url: `/policy`,
});
	...
	return (
		<>
			<div className="bp flex items-center justify-center">
				<PageHeading className="flex items-center justify-start gap-x-2">Privacy Policy</PageHeading>
			</div>
			<BorderSeparator />
			<div className="prose lg:prose-lg  xl:prose-xl  dark:prose-invert bp mx-auto">
				<p>
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Our&quot; in this Agreement) refers to {domain}.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to {domain}, accessible from <Link href="/">{siteLink}/</Link>
						</p>
					</li>
					<li>
						<p>
