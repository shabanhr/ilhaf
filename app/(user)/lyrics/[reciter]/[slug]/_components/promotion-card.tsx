	...
	return (
		<Card className="group mx-auto my-5 w-full">
			<CardHeader>
				...
				>
					<Badge variant="secondary">{topLabel}</Badge>
					<Sparkles className="text-primary size-5 transition-all duration-300 group-hover:animate-pulse" />
				</div>
			</CardHeader>
			<CardContent
			...
			>
				<div className="flex w-full flex-col items-start justify-center">
					<p className="text-foreground mb-3 text-2xl font-extrabold tracking-tight sm:text-3xl">{heading}</p>
			...
			<CardFooter className="flex items-center justify-between rounded-b-xl border-t">
