...
const multiSelectVariants = cva(
    "m-1 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300",
    {
        variants: {
            variant: {
                default:
                    "border-border drop-shadow-md text-foreground bg-card hover:bg-card/80",
                secondary:
                ...
                >
                    <Command>
                        ...
                        <CommandList>
                            ...
                            <CommandGroup>
                                {options.map((option, i) => {
                                    ...
                                    return (
                                        <CommandItem
                                            key={i}
                                            className="w-full flex items-center gap-x-2 justify-between py-0.5"
                                        >
                                            <div
                            ...
                            <CommandSeparator />
                            <CommandGroup className="sticky bottom-0 pt-1 h-full w-full bg-background">
                                <div className="flex items-center justify-between">
                                    {selectedValues.length > 0 && (
                                        <Button
                                            onClick={() => {
